...
const { registerClient, getClients, detailClient, editClient } = require("./controllers/clientController")
...
route.put("/cliente/:id", validateRequest(clientSchema), editClient);
